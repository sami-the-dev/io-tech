...
export interface ApiLegalServiceLegalService
  ...
  info: {
    description: 'Detailed legal services for the About page';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    subtitles: Schema.Attribute.Component<'content.subtitle', true>;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Legal team members and their information';
